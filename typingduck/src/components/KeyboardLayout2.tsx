...
interface KeyboardLayout2Interface {
  onKeyUp?: () => void;
  onKeyDown?: () => string;
}

const KeyboardLayout2: React.FC<KeyboardLayout2Interface> = ({
  onKeyDown,
  onKeyUp,
}) => {
  const [keyboardKey, setKeyboardKey] = useState<Element | null>(null);

  // when the user releases the key
//   useEffect(() => {
//     if (keyboardKey) {
//       keyboardKey.removeAttribute("data-pressed");
//       onKeyUp();
//     }
//   }, [onKeyUp]);
...
//   useEffect(() => {
//     const letter = onKeyDown();
//     if (letter) {
//       setKeyboardKey(
//         document.querySelector(`[data-char="${letter.toUpperCase()}"]`)
//       );
//     }
//   }, [onKeyDown]);
...
export default KeyboardLayout2;
